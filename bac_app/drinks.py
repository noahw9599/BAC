"""
Drink definitions and alcohol content for BAC tracking.
...
# Ethanol density (g/mL) for volume × ABV → grams
...
def grams_from_volume_abv(volume_oz: float, abv: float) -> float:
    """Convert fluid oz and ABV (0–1) to grams of ethanol."""
...
def grams_from_drink(
    ...
    """
    Grams of ethanol for a drink type.
    Uses default serving if volume_oz is None; otherwise volume_oz is total fl oz.
    count = number of standard servings (e.g. 2 beers).
    """
