...
CATALOG: List[CatalogEntry] = [
    ...
    _e(0.14, 5, 165, 10, 9, "Vodka cranberry", "cocktail", "vodka-cran"),
    _e(0.14, 5, 155, 7, 0, "Vodka diet coke", "cocktail", "vodka-diet-coke"),
    _e(0.14, 5, 185, 14, 13, "Vodka red bull", "cocktail", "vodka-red-bull"),
    _e(0.14, 5, 175, 12, 11, "Vodka lemonade", "cocktail", "vodka-lemonade"),
    _e(0.14, 5, 170, 11, 9, "Vodka sprite", "cocktail", "vodka-sprite"),
    _e(0.14, 5, 165, 8, 7, "Vodka tonic", "cocktail", "vodka-tonic"),
    _e(0.14, 5, 170, 10, 9, "Vodka pineapple", "cocktail", "vodka-pineapple"),
    _e(0.14, 5, 165, 9, 8, "Vodka orange", "cocktail", "vodka-orange"),
    _e(0.14, 5, 168, 10, 9, "Vodka water + Mio", "cocktail", "vodka-water-mio"),
    _e(0.14, 5, 180, 13, 12, "Tequila sunrise", "cocktail", "tequila-sunrise-classic"),
    _e(0.14, 5, 155, 7, 0, "Tequila diet coke", "cocktail", "tequila-diet-coke"),
    _e(0.14, 5, 170, 11, 9, "Tequila sprite", "cocktail", "tequila-sprite"),
    _e(0.14, 5, 160, 8, 7, "Tequila soda + lime", "cocktail", "tequila-soda"),
    _e(0.14, 5, 165, 9, 8, "Tequila tonic", "cocktail", "tequila-tonic"),
    _e(0.14, 5, 175, 12, 11, "Tequila lemonade", "cocktail", "tequila-lemonade"),
    _e(0.14, 5, 165, 10, 8, "Tequila pineapple", "cocktail", "tequila-pineapple"),
    _e(0.14, 5, 165, 9, 8, "Tequila cranberry", "cocktail", "tequila-cran"),
    _e(0.14, 5, 165, 10, 9, "Tequila orange", "cocktail", "tequila-orange"),
    _e(0.14, 5, 165, 8, 7, "Ranch water", "cocktail", "ranch-water"),
    _e(0.14, 5, 175, 12, 11, "Rum and coke", "cocktail", "rum-coke"),
    _e(0.14, 5, 155, 7, 0, "Rum and diet coke", "cocktail", "rum-diet-coke"),
    _e(0.14, 5, 170, 11, 9, "Rum and sprite", "cocktail", "rum-sprite"),
    _e(0.14, 5, 175, 12, 11, "Gin and juice", "cocktail", "gin-juice"),
    _e(0.14, 5, 155, 8, 0, "Whiskey diet coke", "cocktail", "whiskey-diet-coke"),
    _e(0.14, 5, 185, 14, 13, "Whiskey ginger", "cocktail", "whiskey-ginger"),
    _e(0.14, 5, 185, 14, 13, "Jameson ginger", "cocktail", "jameson-ginger"),
    _e(0.16, 2.5, 135, 2, 2, "Green tea shot", "cocktail", "green-tea-shot"),
    _e(0.16, 2.5, 150, 4, 4, "Lemon drop shot", "cocktail", "lemon-drop-shot"),
    _e(0.16, 2.5, 145, 3, 3, "White tea shot", "cocktail", "white-tea-shot"),
    _e(0.17, 2.5, 155, 5, 5, "Vegas bomb", "cocktail", "vegas-bomb"),
    _e(0.17, 2.5, 170, 7, 7, "Jager bomb", "cocktail", "jager-bomb"),
    _e(0.17, 2.5, 165, 6, 6, "Cherry bomb", "cocktail", "cherry-bomb"),
